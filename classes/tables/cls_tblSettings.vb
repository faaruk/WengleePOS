Public Class cls_tblSettings
    ...
    Structure Fields
        ...
        Dim email As String
        Dim OrderPrinterName As String
    ...
    Private ReadOnly Property tblSettings_Select
        Get
...
WHERE 1=1
    ...
    Function Update_field(ByVal _fieldName As FieldName, ByVal value As Object) As Integer
        ...
        Dim comUpdate As New SqlCommand("Update [tblSettings] Set [" & _fieldName.ToString & "]=@" & _fieldName.ToString, _conn) ' & " WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
    ...
    Function Selection(Optional ByVal _selection_type As SelectionType = SelectionType.All, Optional ByVal _SelectString As String = "", Optional ByVal _params As List(Of SqlParameter) = Nothing, Optional ByVal _conn As SqlConnection = Nothing, Optional ByVal _transac As SqlTransaction = Nothing) As DataTable
        ...
        Select Case _selection_type
            Case SelectionType.All
                comSelection.CommandText = tblSettings_Select & IIf(_SelectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _SelectString, " AND " & _SelectString), "")
        ...
        Return dt
    End Function
    Function Selection_One_Row(Optional ByVal ItemId As Integer = 1, Optional ByVal _conn As SqlConnection = Nothing, Optional ByVal _transac As SqlTransaction = Nothing) As Fields
        Dim dt As New DataTable
        ...
        If Not _transac Is Nothing Then
            comSelection.Transaction = _transac
        End If
        comSelection.CommandText = tblSettings_Select & " AND [ItemId]=@ItemId"
        ...
        Try
            ...
            With return_field
                ...
                .OrderPrinterName = dt.Rows(0).Item("OrderPrinterName")
                .PrintOrder = dt.Rows(0).Item("PrintOrder")
                .ReportPrinterName = dt.Rows(0).Item("ReportPrinterName")
            End With
    ...
    Function SelectScalar(ByVal _fieldName As FieldName, _
        ...
        Dim comSelectScalar As New SqlCommand("SELECT TOP 1 " & _fieldName.ToString & " [tblSettings] WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
        If Not _transac Is Nothing Then
    ...
    Function SelectDistinct(ByVal _fieldName As FieldName, _
        ...
        Dim comSelectDistinct As New SqlCommand("SELECT DISTINCT " & _fieldName.ToString & " [tblSettings] WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
        If Not _transac Is Nothing Then
