Public Class cls_tblMasterItems
    ...
    Enum FieldName
        ...
        Comments
    End Enum
    Private ReadOnly Property tblMasterItems_insert
        Get
...
WHERE
    ...
    Private ReadOnly Property tblMasterItems_Delete_By_ItemId
        Get
            Return <tblMasterItems_Delete><![CDATA[

DELETE FROM
[tblMasterItems] 
WHERE
[ItemId]=@ItemId
                    ]]></tblMasterItems_Delete>.Value
        End Get
    End Property
...
SELECT MAX([ItemId]) FROM [tblMasterItems] WHERE 1=1
        ...
        End Get
    End Property
    Private ReadOnly Property tblMasterItems_Select
        Get
...
WHERE 1=1
    ...
    Function Insert(ByVal ItemType As String, _
        ...
        With comInsert.Parameters
            ...
            .AddWithValue("@ItemType", ItemType)
            .AddWithValue("@ItemName", ItemName)
            .AddWithValue("@ItemValue", ItemValue)
    ...
    Function Update_field(ByVal _fieldName As FieldName, ByVal value As Object, _
        ...
        Dim comUpdate As New SqlCommand("Update [tblMasterItems] Set [" & _fieldName.ToString & "]=@" & _fieldName.ToString & " WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
        If Not _transac Is Nothing Then
    ...
    Function Delete_By_ItemId(ByRef ItemId As Integer, _
        ...
        Dim comDelete As New SqlCommand(tblMasterItems_Delete_By_ItemId, _conn)
        If Not _transac Is Nothing Then
    ...
    Function Delete_By_SELECT(ByRef _selectstring As String, Optional ByVal _params As List(Of SqlParameter) = Nothing, _
        ...
        Dim comDelete As New SqlCommand(tblMasterItems_Delete_By_SELECT & IIf(_selectstring <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _selectstring, " AND " & _selectstring), ""), _conn)
        If Not _transac Is Nothing Then
            comDelete.Transaction = _transac
        End If
        With comDelete.Parameters
    ...
    Function Selection(Optional ByVal _selection_type As SelectionType = SelectionType.All, Optional ByVal _SelectString As String = "", Optional ByVal _params As List(Of SqlParameter) = Nothing, Optional ByVal _conn As SqlConnection = Nothing, Optional ByVal _transac As SqlTransaction = Nothing) As DataTable
        ...
        Select Case _selection_type
            Case SelectionType.All
                comSelection.CommandText = tblMasterItems_Select & IIf(_SelectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _SelectString, " AND " & _SelectString), "")
    ...
    Function Selection_One_Row(ByVal ItemId As Integer, Optional ByVal _conn As SqlConnection = Nothing, Optional ByVal _transac As SqlTransaction = Nothing) As Fields
        ...
        If Not _transac Is Nothing Then
            comSelection.Transaction = _transac
        End If
        comSelection.CommandText = tblMasterItems_Select & " AND [ItemId]=@ItemId"
        ...
        Try
            ...
            With return_field
                ...
                .ItemType = dt.Rows(0).Item("ItemType")
                .ItemName = dt.Rows(0).Item("ItemName")
                .ItemValue = dt.Rows(0).Item("ItemValue")
    ...
    Function SelectScalar(ByVal _fieldName As FieldName, _
        ...
        Dim comSelectScalar As New SqlCommand("SELECT TOP 1 " & _fieldName.ToString & " from [tblMasterItems] WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
        If Not _transac Is Nothing Then
    ...
    Function SelectDistinct(ByVal _fieldName As FieldName, _
        ...
        Dim comSelectDistinct As New SqlCommand("SELECT DISTINCT " & _fieldName.ToString & "  from [tblMasterItems] WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
        If Not _transac Is Nothing Then
