Public Class cls_tblRouteOrders
    ...
    Enum FieldName
        ...
        RouteID
    End Enum
    Private ReadOnly Property tblRouteOrders_insert
        Get
...
[ItemId]=@ItemId
    ...
    Private ReadOnly Property tblRouteOrders_Delete_By_ItemId
        Get
            Return <tblRouteOrders_Delete><![CDATA[

DELETE FROM
[tblRouteOrders] 
WHERE
[ItemId]=@ItemId
                    ]]></tblRouteOrders_Delete>.Value
        End Get
    End Property
...
SELECT MAX([ItemId]) FROM [tblRouteOrders] WHERE 1=1
        ...
        End Get
    End Property
    Private ReadOnly Property tblRouteOrders_Select
        Get
...
WHERE OrderId in (select OrderId from tblOrder) and 1=1
    ...
    Function Insert(ByVal Sl As Integer, _
    ...
    Function Update_field(ByVal _fieldName As FieldName, ByVal value As Object, _
        ...
        Dim comUpdate As New SqlCommand("Update [tblRouteOrders] Set [" & _fieldName.ToString & "]=@" & _fieldName.ToString & " WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
        If Not _transac Is Nothing Then
    ...
    Function Delete_By_ItemId(ByRef ItemId As Integer, _
        ...
        Dim comDelete As New SqlCommand(tblRouteOrders_Delete_By_ItemId, _conn)
        If Not _transac Is Nothing Then
    ...
    Function Delete_By_Select(ByRef _SelectString As String, Optional ByVal _params As List(Of SqlParameter) = Nothing, _
        ...
        Dim comDelete As New SqlCommand(tblRouteOrders_Delete_By_SELECT & IIf(_SelectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _SelectString, " AND " & _SelectString), ""), _conn)
        If Not _transac Is Nothing Then
            comDelete.Transaction = _transac
        End If
    ...
    Function Selection(Optional ByVal _selection_type As SelectionType = SelectionType.All, Optional ByVal _SelectString As String = "", Optional ByVal _params As List(Of SqlParameter) = Nothing, Optional ByVal _conn As SqlConnection = Nothing, Optional ByVal _transac As SqlTransaction = Nothing) As DataTable
        ...
        Select Case _selection_type
            Case SelectionType.All
                comSelection.CommandText = tblRouteOrders_Select & IIf(_SelectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _SelectString, " AND " & _SelectString), "")
    ...
    Function Selection_One_Row(ByVal ItemId As Integer, Optional ByVal _conn As SqlConnection = Nothing, Optional ByVal _transac As SqlTransaction = Nothing) As Fields
        ...
        If Not _transac Is Nothing Then
            comSelection.Transaction = _transac
        End If
        comSelection.CommandText = tblRouteOrders_Select & " AND [ItemId]=@ItemId"
    ...
    Function SelectScalar(ByVal _fieldName As FieldName, _
        ...
        Dim comSelectScalar As New SqlCommand("SELECT TOP 1 " & _fieldName.ToString & "  from [tblRouteOrders] WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
        If Not _transac Is Nothing Then
    ...
    Function SelectDistinct(ByVal _fieldName As FieldName, _
        ...
        Dim comSelectDistinct As New SqlCommand("SELECT DISTINCT " & _fieldName.ToString & "  from [tblRouteOrders] WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectstring.Trim.ToUpper.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
        If Not _transac Is Nothing Then
