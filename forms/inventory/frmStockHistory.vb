Public Class frmStockHistory
    ...
    Sub LoadList()
        Try
            ...
            Dim dt As DataTable = objProductPrice.Selection(cls_tblStock.SelectionType.OtherInfo_withoutTotal, "a.[ProductId]=@ProductID and a.TransactionDate<=@StockTill " & strNew & " Order By a.transactiondate Desc, a.createddate desc, a.stockid desc", paramList)
