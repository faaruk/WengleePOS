Public Class frmPriceList
    ...
    Sub LoadItems()
        ...
        Try
            ...
            DataGridView1.Columns("StockQty").Visible = False
            ...
            DataGridView1.Columns("FreshStock").Visible = False
            ...
            DataGridView1.Columns("FrozenStock").Visible = False

            'DataGridView1.Columns("Future Orders").ReadOnly = True
            'DataGridView1.Columns("Future Orders").HeaderText = "Future Orders"
            ...
            DataGridView1.Columns("Target Stock Levels").Visible = False
            ...
            DataGridView1.Columns("VendorItemCode").Visible = False
                ...
                If dr.Cells("Cost Price").Value <> dr.Cells("lc").Value Or dr.Cells("Selling Price").Value <> dr.Cells("ls").Value Or dr.Cells("Column2").Value <> dr.Cells("vi").Value Or dr.Cells("UnitOfMesuare2").Value <> dr.Cells("um2").Value Or dr.Cells("VendorItemCode").Value <> dr.Cells("vc").Value Then
                    Try
                        ...
                        objProductPrices.Insert(PID:=dr.Cells("ProductId").Value, CostPrice:=dr.Cells("Cost Price").Value, _
                                                                                               SellPrice:=dr.Cells("Selling Price").Value, EntryDate:=Now, UserId:=UserId, VendorId:=pps.VendorId, UnitOfMesuare:=pps.UnitOfMesuare, VendorItemCode:=pps.VendorItemCode)
    ...
    Private Sub btnPrint_Click(sender As System.Object, e As System.EventArgs) Handles btnPrint.Click
        ...
        frm.PrintPreview(DataGridView1, "Prices", "As on " & Today.ToString, "", "", True, "", True, True)
        'DataGridView1.Columns(0).Visible = False
        'DataGridView1.Columns(1).Visible = False
    ...
    Private Sub btnExport_Click(sender As System.Object, e As System.EventArgs) Handles btnExport.Click
        ...
        Dim Header1 As String = "Price List"
