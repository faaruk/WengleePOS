Public Class frmInventoryListFz
    ...
    Sub LoadItems()
        ...
        Try
            Dim dt As DataTable = objProductPrices.Selection(cls_tblProductPrice.SelectionType.All_Product, selects & " 1=1 and FZStatus=1 Order By a.[ProductId]", ParameterList)
            ...
            If Not arranged Then
                ...
                DataGridView1.Columns("FrozenStock").HeaderText = "FZ In Stock"
